...
inline constexpr const char* kSdkSocket = "/run/kinect360-remold/sdk.sock";
inline constexpr const char* kDeviceDirectory = "/run/kinect360-remold/devices";
inline constexpr const char* kAudioDirectory = "/run/kinect360-remold/audio";
inline constexpr const char* kVirtualCameraMap = "/run/kinect360-remold/virtual-cameras.tsv";
...
// Model-neutral control ABI shared by all runtime backends.
inline constexpr uint32_t kVersion = 1;
inline constexpr uint32_t kStateTiltVerified = 0x80000000u;
...
enum class LedMode : int32_t { Off=0, Green=1, Red=2, BlinkGreen=4 };
#pragma pack(push,1)
...
enum class Command:uint32_t { SubscribeStreams=1, GetDriverSettings=2, SetDriverSettings=3 };
...
enum DriverSetting:uint32_t { DriverSettingRgbHighQuality=1, DriverSettingSupported=DriverSettingRgbHighQuality };
enum Capability:uint32_t { CapabilityRgbDepthConcurrent=1, CapabilityExclusiveVideoMode=2, CapabilityProjectorRefCounted=4, CapabilityAccelerometer=8, CapabilityRgbHighQuality=16, CapabilityRawSensorFrames=64, CapabilityPersistentIsoSession=128 };
...
struct Reply { uint32_t magic=kMagic, version=kVersion; int32_t result=0; uint32_t acceptedMask=0, width=kWidth, height=kHeight,
  capabilities=CapabilityRgbDepthConcurrent|CapabilityExclusiveVideoMode|CapabilityProjectorRefCounted|CapabilityAccelerometer|CapabilityRgbHighQuality|CapabilityRawSensorFrames|CapabilityPersistentIsoSession, maxPayloadBytes=kMaxPayloadBytes;
...
inline constexpr uint32_t MotionAccelerometerValid=0x00000001u, MotionTiltValid=0x00000002u;
...
inline constexpr uint32_t kMagic=0x43414D52u, kVersion=1;
...
#pragma pack(pop)
static_assert(sizeof(Request)==16); static_assert(sizeof(Reply)==20);
}
