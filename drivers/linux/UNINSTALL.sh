...
# Restore the stock Linux Kinect camera driver after removing the Remold
# blacklist. This makes physical devices immediately available to the host
# again instead of leaving them detached until the next boot/replug.
