...
The generated publication contains the camera/device/audio PnP packages, user-mode bridges, virtual camera, IP camera, setup utility and installation scripts. Driver signing is performed by the configured build environment.

See `../../../docs/BUILD-DRIVERS.md` and `../../../docs/windows/ARCHITECTURE.md`.
