...
// Motion sampling contract. The camera service owns periodic status polling
...
inline constexpr MotionPolicy MotionPolicyFor(Model) noexcept {
...
static_assert(Kinect360RemoldHardware::MotionPolicyFor(Kinect360RemoldHardware::Model::Xbox1473).pollPeriodMs == 25u);
static_assert(Kinect360RemoldHardware::MotionPolicyFor(Kinect360RemoldHardware::Model::Xbox1414).staleAfterMs == 250u);
static_assert(Kinect360RemoldHardware::MotionPolicyFor(Kinect360RemoldHardware::Model::Xbox1473).staleAfterMs == 250u);
