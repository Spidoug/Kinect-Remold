...
// Kinect Runtime microphone transport after UAC firmware launch.  The 1473
// retains its own MI_00 control topology for motor/LED/accelerometer while
// MI_02 remains owned by the native Windows USB Audio stack.  bInterval is
// firmware-defined and is intentionally not overridden or fabricated here.
