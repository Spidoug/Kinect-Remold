...
// Raw four-microphone transport. Processing connects directly to this local
// pipe. The standard Remold package does not install a custom Windows audio kernel endpoint.
constexpr wchar_t kPipePrefix[] = L"Kinect360RemoldAudio-";
constexpr wchar_t kStatusDirectory[] = L"Kinect360Remold";
constexpr wchar_t kStatusFileName[] = L"audio-bridge-status.txt";
...
struct Reply {
    ...
    // Raw four-channel capture is the complete audio contract.
