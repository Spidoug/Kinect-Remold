@{
    ...
    # Primary aliases used when one canonical Xbox identity is required.
    # Runtime discovery itself uses the arrays above.
    ...
    # Kinect Runtime microphone data interface used by the application bridge.
