...
throw ('Automatic Microsoft toolchain bootstrap did not produce a usable MSBuild/SDK/WDK environment. ' +
       'See the WinGet/Visual Studio output above. If Windows requested a restart, restart once and run Kinect-Xbox-360-Remold.cmd --rebuild again; all successfully installed components will be reused.')
