...
The audio runtime uses Microsoft inbox USB audio facilities and a Remold user-mode bridge:
...
The package does not require an authored Remold kernel audio `.sys` file. The Remold Audio INF binds the temporary firmware-boot interface to Microsoft WinUSB and installs the user-mode bridge service.
