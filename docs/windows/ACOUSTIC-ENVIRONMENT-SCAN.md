...
The beamformed mono stream is written to the current Java/Windows playback output at 16 kHz/16-bit. The four raw microphone channels remain unchanged for channel inspection and DOA/TDOA processing.
