...
- [Motion contract](MOTION.md) — per-model tilt/accelerometer sampling and Smart Tilt, identical on Linux and Windows.
...
- [Parity validation](linux/PARITY-VALIDATION.md)
